...
export const PRODUCTS_LIST: ProductItem[] = [
  {
    id: "prod-rr",
    name: "RailJet Clamp Earth Resistance Tester (Model: RR / FR2000A+)",
    category: "Earth Clamp Testers",
    code: "RJ-RR / FR2000A+",
    model: "Model: RR (FR2000A+)",
  ...
  {
    id: "prod-rr-plus",
    name: "RailJet Clamp Earth Resistance & Current Tester (Model: RR+ / FR2000+)",
    category: "Earth Clamp Testers",
    code: "RJ-RR+ / FR2000+",
    model: "Model: RR+ (FR2000+)",
    sourceDoc: "RALIJET CLAMP EARTH RESISTANCE MENU.pdf",
    pdfUrl: "/docs/RALIJET%20CLAMP%20EARTH%20RESISTANCE%20MENU.pdf",
    rdsoCompliant: true,
  ...
  {
    id: "prod-r1",
    name: "RailJet Clamp Earth Resistance & Leakage Tester (Model: R1 / FR2000B+)",
    category: "Earth Clamp Testers",
    code: "RJ-R1 / FR2000B+",
    model: "Model: R1 (FR2000B+)",
    sourceDoc: "RALIJET CLAMP EARTH RESISTANCE MENU.pdf",
    pdfUrl: "/docs/RALIJET%20CLAMP%20EARTH%20RESISTANCE%20MENU.pdf",
    rdsoCompliant: true,
  ...
  {
    id: "prod-r1-plus",
    name: "RailJet Clamp Earth Resistance Tester (Model: R1+ / FR2000C+)",
    category: "Earth Clamp Testers",
    code: "RJ-R1+ / FR2000C+",
    model: "Model: R1+ (FR2000C+)",
    sourceDoc: "RALIJET CLAMP EARTH RESISTANCE MENU.pdf",
    pdfUrl: "/docs/RALIJET%20CLAMP%20EARTH%20RESISTANCE%20MENU.pdf",
    rdsoCompliant: true,
  ...
  {
    id: "prod-r2",
    name: "RailJet Ground Pile Clamp Earth Resistance Tester (Model: R2 / ES3022)",
    category: "Earth Clamp Testers",
    code: "RJ-R2 / ES3022",
    model: "Model: R2 (ES3022)",
  ...
  {
    id: "prod-r3",
    name: "RailJet Multi-Functional Soil Resistivity & Grounding Tester (Model: R3 / ES3022E)",
    category: "Soil Resistivity Testers",
    code: "RJ-R3 / ES3022E",
    model: "Model: R3 (ES3022E)",
    sourceDoc: "ES3022 Series user manual.pdf",
    pdfUrl: "/docs/ES3022%20Series%20user%20manual.pdf",
    rdsoCompliant: true,
  ...
  {
    id: "prod-r3-plus",
    name: "RailJet Advanced Smart Soil Resistivity & Clamp Tester (Model: R3+ / ES3022F)",
    category: "Soil Resistivity Testers",
    code: "RJ-R3+ / ES3022F",
    model: "Model: R3+ (ES3022F)",
    sourceDoc: "ES3022 Series user manual.pdf",
    pdfUrl: "/docs/ES3022%20Series%20user%20manual.pdf",
    rdsoCompliant: true,
